...
describe('hsql in memory', () => {
    ...
    describe('query', () => {
        ...
        it('should fail queryAsStream with oops error', (done) => {
            ...
            stream.on('error', (err) => {
                try {
                    (0, chai_1.expect)(err.message).to.equal('Invalid argument in JDBC call: parameter index out of range: 1');
                    done();
                }
                catch (e) {
                    done(e);
    ...
    describe('batch update', () => {
        ...
        it('should fail insert batch with oops-error', () => {
            ...
            return jt400
                ...
                .catch((error) => {
                (0, chai_1.expect)(error.message).to.equal('data exception: invalid datetime format');
