...
describe('jt400 pool', () => {
    ...
    it('should fail execute query with oops-error', () => {
        ...
        return db_1.jt400
            ...
            .catch((error) => {
            (0, chai_1.expect)(error.message).to.equal('[SQL0104] Token - was not valid. Valid tokens: FOR USE SKIP WAIT WITH FETCH LIMIT ORDER UNION EXCEPT OFFSET.');
            (0, chai_1.expect)(error.context.sql).to.equal(sql);
            (0, chai_1.expect)(error.context.params).to.equal(undefined);
            (0, chai_1.expect)(error.category).to.equal('ProgrammerError');
        });
    });
